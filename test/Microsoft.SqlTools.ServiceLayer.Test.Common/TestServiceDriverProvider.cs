...
namespace Microsoft.SqlTools.ServiceLayer.Test.Common
{
    ...
    public sealed class TestServiceDriverProvider : IDisposable
    {
        ...
        /// Request the active SQL script is parsed for errors
        /// </summary>
        public void RequestOpenDocumentNotification(DidOpenTextDocumentNotification openParams)
        {
            Driver.SendEvent(DidOpenTextDocumentNotification.Type, openParams);
        }

        /// <summary>
        /// Request a configuration change notification
        /// </summary>
        public void RequestChangeConfigurationNotification(DidChangeConfigurationParams<SqlToolsSettings> configParams)
        {
            Driver.SendEvent(DidChangeConfigurationNotification<SqlToolsSettings>.Type, configParams);
        }

        /// <summary>
        /// /// Request the active SQL script is parsed for errors
        /// </summary>
        public void RequestChangeTextDocumentNotification(DidChangeTextDocumentParams changeParams)
        {
            Driver.SendEvent(DidChangeTextDocumentNotification.Type, changeParams);
        }
